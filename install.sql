...
@@application/shared_components/files/silicium_png.sql
@@application/shared_components/files/windows_png.sql
@@application/shared_components/files/uefi_png.sql
@@application/shared_components/files/phones2_jpg.sql
...
@@application/shared_components/user_interface/lovs/manufacturers_manufacturer_name.sql
@@application/shared_components/user_interface/lovs/socs_soc_name.sql
...
@@application/shared_components/user_interface/templates/page/my_template.sql
